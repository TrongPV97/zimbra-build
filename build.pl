...
sub Clone($$)
{
   ...
   print color('green') ."Clone git : repo_name-> $repo_name, repo_branch_csv-> $repo_branch_csv, repo_tag_csv-> $repo_tag_csv, repo_remote-> $repo_remote, repo_url_prefix-> $repo_url_prefix";
